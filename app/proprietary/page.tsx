...
export const metadata: Metadata = {
  title: "Proprietary Trading Desk | ACE CAPITAL",
  description: "Gain access to Tier-1 institutional capital with high-leverage mandates and zero personal liability. Join our proprietary trading intake today.",
  alternates: {
    canonical: "/proprietary",
  },
}

export default function ProprietaryTrading() {
  const propFAQs = [
    {
  ...
  const proprietarySchema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://acecapitalenterprise.com/proprietary/#webpage",
        "url": "https://acecapitalenterprise.com/proprietary",
        "name": "Proprietary Trading Desk | ACE CAPITAL",
        "description": "Gain access to Tier-1 institutional capital with high-leverage mandates and zero personal liability. Join our proprietary trading intake today.",
        "isPartOf": {
          "@type": "WebSite",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://acecapitalenterprise.com/proprietary/#faq",
        "isPartOf": {
          "@id": "https://acecapitalenterprise.com/proprietary/#webpage"
        },
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(proprietarySchema) }}
      />
      ...
      {/* Proprietary Trading FAQ Section */}
      <section className="ace-section ace-container border-t border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {propFAQs.map((faq, idx) => (
            <div key={idx} className="ace-card p-8 rounded space-y-4 border border-outline-variant/10 hover:border-secondary/30 transition-all">
              <h3 className="font-data-point text-secondary uppercase tracking-wider text-base">
                {faq.question}
              </h3>
