...
export default function MutualFundsCalculator() {
  ...
  return (
    <div className="bg-white p-6 md:p-10 rounded-xl border border-outline-variant/30 shadow-sm font-sans w-full max-w-6xl mx-auto my-8">
      ...
      {/* Banner */}
      <div className="bg-[#F8FAFC] border border-outline-variant/20 rounded-lg p-5 flex items-center gap-3 mb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 border-t border-outline-variant/20 pt-10">
                    ...
                    <div key={idx} className="flex-1 flex flex-col justify-end items-center group relative h-full z-10">
                      ...
                      <div className="w-full max-w-[20px] flex flex-col justify-end h-full">
                        <div 
                          ...
                          className="bg-[#0B214D] w-full rounded-t-sm transition-all duration-300"
                        ></div>
                        <div 
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-[#F8FAFC] border border-outline-variant/20 rounded-xl p-6 flex justify-between items-center shadow-sm">
          ...
          <div className="bg-[#F8FAFC] border border-[#1E3A8A]/30 rounded-xl p-6 flex justify-between items-center shadow-sm relative overflow-hidden">
