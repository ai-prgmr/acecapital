      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-muted border border-border rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-12 overflow-hidden relative group hover:border-secondary transition-colors duration-500">
          <div className="relative w-full flex-1 h-48">
            <Image src="/images/goals/retirement_planning_goal.png" alt="Retirement Planning" layout="fill" objectFit="cover" className="rounded-lg" />
          </div>
        ...
        <div className="bg-muted border border-border rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative group hover:border-secondary transition-colors duration-500">
          <div className="z-10 space-y-4">
            <div className="relative w-full h-48 mb-4">
              <Image src="/images/goals/children_education_goal.jpg" alt="Children's Education" layout="fill" objectFit="cover" className="rounded-lg" />
            </div>
        ...
        <div className="bg-muted border border-border rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative group hover:border-secondary transition-colors duration-500">
          <div className="z-10 space-y-4">
            <div className="relative w-full h-48 mb-4">
              <Image src="/images/goals/child_marriage_goal.png" alt="Child's Marriage" layout="fill" objectFit="cover" className="rounded-lg" />
            </div>
        ...
        <div className="bg-muted border border-border rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative group hover:border-secondary transition-colors duration-500">
          <div className="z-10 space-y-4">
            <div className="relative w-full h-48 mb-4">
              <Image src="/images/goals/diversification_goal.jpg" alt="Portfolio Diversification" layout="fill" objectFit="cover" className="rounded-lg" />
            </div>
        ...
        <div className="bg-muted border border-border rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative group hover:border-secondary transition-colors duration-500">
          <div className="z-10 space-y-4">
            <div className="relative w-full h-48 mb-4">
              <Image src="/images/goals/wealth_creation_goal.png" alt="Wealth Creation" layout="fill" objectFit="cover" className="rounded-lg" />
            </div>
